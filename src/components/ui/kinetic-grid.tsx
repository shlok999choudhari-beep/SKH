...
export default function KineticGrid({
  ...
  const draw = useCallback(
    (now: number) => {
      ...
      const theme = {
        default: {
          bg: "#050816",
          lineActive: { r: 139, g: 92, b: 246, a: 0.9 },
          nodeActive: { r: 139, g: 92, b: 246, a: 1.0 },
          glow: "139,92,246",
          ripple: "168,85,247",
        },
        monochrome: {
  ...
  const backgroundCanvas = (
    <div
      className={cn(
        ...
        globalColor === "monochrome" ? "bg-[#000000]" : "bg-[#050816]",
        className
      )}
      style={{ zIndex: -10 }}
    >
  ...
  return (
    <>
      {mounted ? createPortal(backgroundCanvas, document.body) : null}
